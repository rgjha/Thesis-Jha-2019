...
dimensions on the lattice while preserving exact supersymmetry. The lattice simulations of maximally 
supersymmetric theories play an important role in understanding various aspects of holography in more detail by directly
dealing with strongly coupled field theories. Though, there have been numerous calculations on the gravity side 
...
when we study field theories at finite couplings to understand the nature of stringly corrections in the 
supergravity side when it is no longer weakly-coupled. To initiate such a program in $ d >1$, in two dimensions,
we studied the phase diagram of the SYM theory and located the deconfinement transition which 
is related to the transition between two different black hole solutions using holography.  
