...
holographic correspondence between supersymmetric gauge theory and a gravity theory on anti-deSitter 
...
\[ \{Q_{\alpha}^{L}, \bar{Q_{\beta}^{M}}\} = \delta^{LM} \sigma^{\mu}_{\alpha\beta} P_{\mu} \] 
